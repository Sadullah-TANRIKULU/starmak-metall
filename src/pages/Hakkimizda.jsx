...
const Hakkimizda = () => {
    return (
        <section className="text-center w-full py-2 px-4 sm:px-10" >
            <h1 className="font-bold" >HAKKIMIZDA</h1>
            <article className="flex flex-col justify-center items-center gap-2" >
                <div className="grid lg:grid-cols-2 gap-2 justify-items-center items-center" >
                    <p className="text-justify" >
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur ad sit numquam omnis, facere commodi est deleniti reprehenderit accusamus eos quo debitis labore aliquam quisquam! Facere tempore accusamus a illum praesentium, eum sed at autem dolorem veniam aperiam iusto dolores?Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo laudantium quidem aut? Quia, hic. Ullam ea qui quasi commodi veniam. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Distinctio iste beatae corrupti illum nemo molestias illo tempore possimus ut necessitatibus, labore pariatur maiores ab aliquam, amet totam natus qui accusamus a! Quia in impedit omnis, mollitia voluptatum unde. Eius excepturi aut hic, quod quis vel magnam tempore placeat iusto iure!
                    </p>
                    <img src={img1Hakkimizda} alt="img1Hakkimizda" className="block w-full" />
                </div>
                <div>
                    <p className="text-justify" >
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perferendis sed dolorum accusantium, suscipit minima sapiente explicabo dolor pariatur facere, error distinctio vel ullam blanditiis? Hic, maxime? Ut assumenda doloremque nam laborum officia, necessitatibus porro molestiae voluptatibus quas quidem mollitia ea! Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque fuga maxime incidunt nemo voluptate cumque tempore repellendus provident eius assumenda! Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint, praesentium. Nulla ad, eos adipisci odit, est magnam tenetur accusantium numquam, doloribus libero error maiores. Beatae corporis at, error, sapiente amet necessitatibus in officiis maxime similique, nisi quam qui omnis ratione ea veniam commodi a nesciunt fuga. Architecto quidem minima dolorum.

                    </p>
                </div>
                <div className="grid lg:grid-cols-2 gap-2 justify-items-center items-center" >
                    <img src={img2Hakkimizda} alt="img2Hakkimizda" className="block w-full" />
                    <p className="text-justify" >
